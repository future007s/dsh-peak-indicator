...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var zh = {
      "badge.peak": "\u26A1 \u9AD8\u5CF0 \u00A5{input}/\u00A5{output}",
      "badge.offpeak": "\u{1F319} \u95F2\u65F6 \u00A5{input}/\u00A5{output}",
    ...
    var en = {
      "badge.peak": "\u26A1 Peak \u00A5{input}/\u00A5{output}",
      "badge.offpeak": "\u{1F319} Off-peak \u00A5{input}/\u00A5{output}",
    ...
    function PeakBadge({ t, directory, load }) {
      ...
      const label = prices === null ? t("badge." + period) : t("badge." + period, { input: formatPrice(prices.input), output: formatPrice(prices.output) });
