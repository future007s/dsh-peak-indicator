...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function PeakBadge({ t, directory, load, useProjection }) {
      ...
      if (current !== null && current !== void 0 && !isDeepseekModel(current?.provider, current?.model)) return null;
     ...
     * the host "peakCost" projection, styled as a period-colored pill like the
     * header badge (green off-peak / red peak).
     */
